            ...
            modelBuilder.Entity("Behlog.Core.Models.Shop.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 3, 6, 15, 12, 32, 420, DateTimeKind.Utc).AddTicks(5181),
                            IsFree = true,
                            MaxDeliveryDays = 0,
                            MinDeliveryDays = 0,
                            ModifyDate = new DateTime(2021, 3, 6, 15, 12, 32, 420, DateTimeKind.Utc).AddTicks(6507),
                            Price = 0m,
                            Status = 1,
                            Title = "پست"
                        });
